...
public class CotifedDatosAdicionalesPage {
	...
	{
		return  SeleniumWaiters.findClickableElement(driver,By.xpath("//div/label[text()='Referencia(*)']/parent::div//select/option[contains(.,'"+referencia+"')]"),10000);	
	}
	...
	{
		return  SeleniumWaiters.findClickableElement(driver,By.xpath("/html/body//div/div/form/div[4]/div/div[2]/div/div[2]/select/option[contains(.,'"+prefijo+"')]"),10000);	
	}
