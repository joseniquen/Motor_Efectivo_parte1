...
Feature: Escenario 7 - Como usuario quiero analizar y aprobar una solicitud de crédito
  ...
  Scenario: EP007: Línea de producto  Efectivo 
    ...
    And Ingreso mi usuario bpm 'ychiroque'
		...
		When Ingreso instancia de proceso "10854683"
		...
		|CHICLAYO   |00522334   |EFECTIVO      |10854683     |
